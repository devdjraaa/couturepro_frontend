...
export default function ClientDetailPage() {
  ...
  // NATIF : la requête locale WatermelonDB attend `clientId`, pas `client_id` (web).
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      // (utils/partageMesures). Cette page en gardait un second, resté
                      // sur la branche android : il figeait l'unité « cm » quel que soit
                      // le réglage de l'atelier, la locale de date en fr-FR, et n'ajoutait
                      // pas le bloc de signature — deux partages du même client ne
                      // donnaient donc pas le même message selon le chemin emprunté.
