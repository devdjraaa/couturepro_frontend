      ...
      <div className="max-w-[1180px] mx-auto px-5">
        ...
        {Array.isArray(c.videos) && c.videos.length > 0 && (
          <>
            ...
            {/* VID-1 — lecture SUR PLACE, en grille de cartes uniformes. Un
                lien sortant envoyait le visiteur sur YouTube, et il ne revenait
                pas forcément ; un lien non reconnu reste un lien, mieux vaut
                cela qu'un cadre vide. Le lecteur n'est chargé qu'AU CLIC : six
                intégrations posées d'emblée, ce sont six connexions tierces
                avant qu'on ait demandé à voir quoi que ce soit. */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {c.videos.map((v, i) => <CarteVideo key={i} video={v} />)}
            </div>
          </>
        )}
